...
public class EliminarUsuario extends javax.swing.JDialog {
     ...
     */
    public EliminarUsuario(java.awt.Frame parent, boolean modal, Maestro m) {
        super(parent, modal);
        initComponents();
        this.maestro = m;
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(255, 254, 205));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel1.setText("¿Estás segur@ de que quieres eliminar tu usuario?");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        dm.EliminarUsuario(maestro);
        esEliminado = true;
        JOptionPane.showMessageDialog(this, "Usuario eliminado correctamente. Cerrando sesión...",
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EliminarUsuario dialog = new EliminarUsuario(new javax.swing.JFrame(), true, null);
